...
using WebApplicationStock.Client.Extensions;
using WebApplicationStock.Shared;

namespace WebApplicationStock.Client.Authentication
{
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        //Method to update the authentication state when user login or logout
